...
{
    public partial class CobroREAUIForm : CobroREAForm
    {
        #region Attributes & Properties

        public new const string ID = "CobroREAUIForm";
        public new static Type Type { get { return typeof(CobroREAUIForm); } }
        ...
        public override Cobro Entity { get { return _entity; } set { _entity = value; } }
        public override CobroInfo EntityInfo { get { return (_entity != null) ? _entity.GetInfo(false) : null; } }
        ...
        /// </summary>
        protected CobroREAUIForm() 
			: this(-1, false, null) { }

        public CobroREAUIForm(Form parent) 
			: this(-1, true, parent) { }

        public CobroREAUIForm(long oid) 
			: this(oid, true, null) { }

        public CobroREAUIForm(long oid, bool isModal, Form parent)
