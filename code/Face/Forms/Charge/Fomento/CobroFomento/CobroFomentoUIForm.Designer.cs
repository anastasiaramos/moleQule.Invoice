...
{
    partial class CobroFomentoUIForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.Vencimiento_DTP.Size = new System.Drawing.Size(100, 21);
			// 
			// mQDateTimePicker2
			// 
			...
			// Ano_CB
			// 
			this.Ano_CB.Font = new System.Drawing.Font("Tahoma", 8.25F);
			this.Ano_CB.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(192)))));
			this.Ano_CB.SelectedIndexChanged += new System.EventHandler(this.Ano_CB_SelectedIndexChanged);
			// 
			// Proporcional_BT
			// 
			this.Proportional_BT.Click += new System.EventHandler(this.Proportional_BT_Click);
			// 
			// PanelesV
			// 
			// 
			...
			this.PanelesV.SplitterDistance = 571;
			// 
			// Submit_BT
			// 
			...
			// Progress_Panel
			// 
			this.Progress_Panel.Location = new System.Drawing.Point(358, 108);
			// 
			// ProgressBK_Panel
			// 
			this.ProgressBK_Panel.Size = new System.Drawing.Size(1074, 626);
			// 
			// ProgressInfo_PB
			// 
			this.ProgressInfo_PB.Location = new System.Drawing.Point(500, 359);
			// 
			// Progress_PB
			// 
			this.Progress_PB.Location = new System.Drawing.Point(500, 274);
			// 
			// CobroFomentoUIForm
			// 
