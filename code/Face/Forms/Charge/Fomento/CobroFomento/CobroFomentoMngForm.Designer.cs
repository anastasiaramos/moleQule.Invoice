...
{
	partial class CobroFomentoMngForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CobroFomentoMngForm));
			this.DatosLocal_BS = new System.Windows.Forms.BindingSource(this.components);
			this.Tabla = new System.Windows.Forms.DataGridView();
			this.IDCobroLabel = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.ETipoCobroLabel = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.Fecha = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.Codigo = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.EMedioPagoLabel = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.EfectoPendienteVto = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.Main_Panel.Size = new System.Drawing.Size(1084, 462);
			// 
			// Letras_Panel
			// 
			...
			this.Content_Panel.Size = new System.Drawing.Size(1084, 346);
			this.Content_Panel.SplitterDistance = 25;
			// 
			// AdvSearch_BT
			// 
			...
			this.Search_Panel.Size = new System.Drawing.Size(1084, 76);
			// 
			// Filters_LB
			// 
			this.Filters_LB.Location = new System.Drawing.Point(0, 45);
			this.HelpProvider.SetShowHelp(this.Filters_LB, true);
			this.Filters_LB.Size = new System.Drawing.Size(1084, 4);
			// 
			// ValorIni_TB
			// 
			...
			// Progress_Panel
			// 
			this.Progress_Panel.Location = new System.Drawing.Point(338, 172);
			// 
			// ProgressBK_Panel
			// 
			this.ProgressBK_Panel.Size = new System.Drawing.Size(1084, 462);
			// 
			// ProgressInfo_PB
			// 
			this.ProgressInfo_PB.Location = new System.Drawing.Point(510, 284);
			// 
			// Progress_PB
			// 
			this.Progress_PB.Location = new System.Drawing.Point(510, 199);
			// 
			// DatosLocal_BS
			// 
			this.DatosLocal_BS.DataSource = typeof(moleQule.Library.Invoice.ChargeInfo);
			// 
			// Tabla
			// 
            ...
            this.IDCobroLabel,
            this.ETipoCobroLabel,
            this.Fecha,
            this.Codigo,
            this.EMedioPagoLabel,
            this.IDLineaCaja,
            this.IDMovimientoBanco,
            this.Importe,
            this.PendienteAsignacion,
            this.Vencimiento,
            this.EfectoPendienteVto,
            this.CuentaBancaria,
            this.Entidad,
            this.Cobrado,
            this.Usuario,
			...
			this.Tabla.DefaultCellStyle = dataGridViewCellStyle19;
			...
			// IDCobroLabel
			// 
			this.IDCobroLabel.DataPropertyName = "IDCobroLabel";
			dataGridViewCellStyle2.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
			this.IDCobroLabel.DefaultCellStyle = dataGridViewCellStyle2;
			this.IDCobroLabel.HeaderText = "ID Cobro";
			this.IDCobroLabel.Name = "IDCobroLabel";
			this.IDCobroLabel.ReadOnly = true;
			this.IDCobroLabel.Width = 60;
			// 
			// ETipoCobroLabel
			// 
			this.ETipoCobroLabel.DataPropertyName = "ETipoCobroLabel";
			dataGridViewCellStyle3.BackColor = System.Drawing.Color.White;
			dataGridViewCellStyle3.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(192)))));
			this.ETipoCobroLabel.DefaultCellStyle = dataGridViewCellStyle3;
			this.ETipoCobroLabel.HeaderText = "Tipo";
			this.ETipoCobroLabel.Name = "ETipoCobroLabel";
			this.ETipoCobroLabel.ReadOnly = true;
			this.ETipoCobroLabel.Width = 90;
			// 
			// Fecha
			// 
			...
			this.Codigo.HeaderText = "Nº Cobro";
			...
			// EMedioPagoLabel
			// 
			this.EMedioPagoLabel.DataPropertyName = "EMedioPagoLabel";
			...
			this.EMedioPagoLabel.DefaultCellStyle = dataGridViewCellStyle6;
			this.EMedioPagoLabel.HeaderText = "Medio Pago";
			this.EMedioPagoLabel.Name = "EMedioPagoLabel";
			this.EMedioPagoLabel.ReadOnly = true;
			this.EMedioPagoLabel.Width = 120;
			// 
			// IDLineaCaja
			// 
			this.IDLineaCaja.DataPropertyName = "IDLineaCaja";
			dataGridViewCellStyle7.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
			this.IDLineaCaja.DefaultCellStyle = dataGridViewCellStyle7;
			this.IDLineaCaja.HeaderText = "ID Caja";
			this.IDLineaCaja.Name = "IDLineaCaja";
			this.IDLineaCaja.ReadOnly = true;
			this.IDLineaCaja.Width = 70;
			// 
			// IDMovimientoBanco
			// 
			this.IDMovimientoBanco.DataPropertyName = "IDMovimientoBanco";
			dataGridViewCellStyle8.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
			this.IDMovimientoBanco.DefaultCellStyle = dataGridViewCellStyle8;
			this.IDMovimientoBanco.HeaderText = "ID Apunte Banco";
			this.IDMovimientoBanco.Name = "IDMovimientoBanco";
			this.IDMovimientoBanco.ReadOnly = true;
			this.IDMovimientoBanco.Width = 70;
			// 
			// Importe
			// 
			...
			// PendienteAsignacion
			// 
			this.PendienteAsignacion.DataPropertyName = "PendienteAsignacion";
			...
			this.PendienteAsignacion.DefaultCellStyle = dataGridViewCellStyle10;
			this.PendienteAsignacion.HeaderText = "Pendiente Asignación";
			this.PendienteAsignacion.Name = "PendienteAsignacion";
			this.PendienteAsignacion.ReadOnly = true;
			this.PendienteAsignacion.Width = 80;
			// 
			// Vencimiento
			// 
			...
			this.Vencimiento.DefaultCellStyle = dataGridViewCellStyle11;
			...
			// EfectoPendienteVto
			// 
			this.EfectoPendienteVto.DataPropertyName = "EfectoPendienteVto";
			dataGridViewCellStyle12.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleRight;
			dataGridViewCellStyle12.Format = "N2";
			this.EfectoPendienteVto.DefaultCellStyle = dataGridViewCellStyle12;
			this.EfectoPendienteVto.HeaderText = "Pendiente Vto.";
			this.EfectoPendienteVto.Name = "EfectoPendienteVto";
			this.EfectoPendienteVto.ReadOnly = true;
			this.EfectoPendienteVto.Width = 80;
			// 
			// CuentaBancaria
			// 
			...
			this.CuentaBancaria.DefaultCellStyle = dataGridViewCellStyle13;
			...
			this.Entidad.Width = 175;
			// 
			// Cobrado
			// 
			this.Cobrado.DataPropertyName = "EstadoCobroLabel";
			dataGridViewCellStyle15.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
			this.Cobrado.DefaultCellStyle = dataGridViewCellStyle15;
			this.Cobrado.HeaderText = "Estado Cobro";
			this.Cobrado.Name = "Cobrado";
			this.Cobrado.ReadOnly = true;
			this.Cobrado.Resizable = System.Windows.Forms.DataGridViewTriState.True;
			this.Cobrado.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.NotSortable;
			this.Cobrado.Width = 70;
			// 
			// Usuario
			// 
			this.Usuario.DataPropertyName = "Usuario";
			dataGridViewCellStyle16.Alignment = System.Windows.Forms.DataGridViewContentAlignment.MiddleCenter;
			this.Usuario.DefaultCellStyle = dataGridViewCellStyle16;
			...
			this.EstadoLabel.DefaultCellStyle = dataGridViewCellStyle17;
			...
			this.Observaciones.DefaultCellStyle = dataGridViewCellStyle18;
			...
			this.Name = "CobroFomentoMngForm";
			this.HelpProvider.SetShowHelp(this, true);
			this.Text = "Cobros: Fomento";
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn IDCobroLabel;
		private System.Windows.Forms.DataGridViewTextBoxColumn ETipoCobroLabel;
		private System.Windows.Forms.DataGridViewTextBoxColumn Fecha;
		private System.Windows.Forms.DataGridViewTextBoxColumn Codigo;
		private System.Windows.Forms.DataGridViewTextBoxColumn EMedioPagoLabel;
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn EfectoPendienteVto;
