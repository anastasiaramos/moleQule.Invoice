    ...
    public partial class CobroFomentoForm : Skin01.ItemMngSkinForm
    {
        ...
        protected void UpdateAsignado()
        {
            ...
            foreach (LineaFomentoInfo item in _facturas)
            {
                ...
                item.Vinculado = item.Cobrado ? Library.Invoice.Resources.Labels.RESET_COBRO : Library.Invoice.Resources.Labels.SET_COBRO;
            }
        ...
        protected virtual void SetVencimientoAction() { }
