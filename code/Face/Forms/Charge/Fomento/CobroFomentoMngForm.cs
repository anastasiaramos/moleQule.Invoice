...
namespace moleQule.Face.Invoice
{
			...
			switch (DataType)
			{
				case EntityMngFormTypeData.Default:
					if (Library.Common.ModulePrincipal.GetUseActiveYear())
						List = CobroList.GetListFomento(Library.Common.ModulePrincipal.GetActiveYear().Year, false);
					else
						List = CobroList.GetListFomento(false);
					break;
    ...
    public partial class CobroFomentoMngBaseForm : Skin06.EntityMngSkinForm<CobroList, CobroInfo>
    {
        public CobroFomentoMngBaseForm()
            : this(false, null, null) { }

        public CobroFomentoMngBaseForm(bool isModal, Form parent, CobroList lista)
