namespace moleQule.Face.Invoice
{
	partial class TicketMngForm
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TicketMngForm));
			...
			this.Main_Panel.Size = new System.Drawing.Size(984, 762);
			// 
			// Letras_Panel
			// 
			...
			this.Content_Panel.Size = new System.Drawing.Size(984, 646);
			this.Content_Panel.SplitterDistance = 617;
			// 
			// AdvSearch_BT
			// 
			...
			// ProgressBK_Panel
			// 
			this.ProgressBK_Panel.Location = new System.Drawing.Point(288, 172);
			// 
			// ProgressBK_Panel
			// 
			this.ProgressBK_Panel.Size = new System.Drawing.Size(984, 762);
			// 
			// ProgressInfo_PB
			// 
			this.ProgressInfo_PB.Location = new System.Drawing.Point(460, 434);
			// 
			// Progress_PB
			// 
			this.Progress_PB.Location = new System.Drawing.Point(460, 349);
			// 
			// DatosLocal_BS
			// 
			this.DatosLocal_BS.DataSource = typeof(moleQule.Library.Invoice.TicketList);
			// 
			// Tabla
			// 
			...
			this.Tabla.Size = new System.Drawing.Size(984, 617);
			...
			this.Codigo.HeaderText = "Nº Ticket";
			...
			this.BaseImponible.DefaultCellStyle = dataGridViewCellStyle5;
			...
			this.IGIC.DefaultCellStyle = dataGridViewCellStyle6;
			this.IGIC.HeaderText = "Impuestos";
			this.IGIC.Name = "IGIC";
			...
			this.Albaranes.DefaultCellStyle = dataGridViewCellStyle8;
			this.Albaranes.HeaderText = "Albaranes";
			this.Albaranes.Name = "Albaranes";
			this.Albaranes.ReadOnly = true;
			this.Albaranes.Width = 125;
			// 
			...
			this.IDMovimientoContable.DefaultCellStyle = dataGridViewCellStyle9;
			...
			this.IDMovimientoContable.Visible = false;
			...
			this.EstadoLabel.DefaultCellStyle = dataGridViewCellStyle11;
