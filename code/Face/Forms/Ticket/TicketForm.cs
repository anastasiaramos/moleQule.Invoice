...
{
    public partial class TicketForm : Skin01.ItemMngSkinForm
    {
        ...
        public TicketForm(Form parent) 
			: this(-1, true, parent) {}

        public TicketForm(long oid)
			: this(oid, false, null) {}

        public TicketForm(long oid, bool isModal, Form parent)
