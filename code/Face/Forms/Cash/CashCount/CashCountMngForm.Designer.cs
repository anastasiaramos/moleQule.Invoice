...
{
	partial class CashCountMngForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CashCountMngForm));
			...
			this.DebeAcumulado = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.HaberAcumulado = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.SaldoAcumulado = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			// Campos_Panel
			// 
			this.Campos_Panel.Location = new System.Drawing.Point(25, 0);
			...
			// ProgressBK_Panel
			// 
			this.ProgressBK_Panel.Location = new System.Drawing.Point(300, 172);
			// 
			// ProgressBK_Panel
			// 
			...
			// DatosLocal_BS
			// 
			this.DatosLocal_BS.DataSource = typeof(moleQule.Library.Invoice.CierreCajaList);
			// 
			// Tabla
			// 
			...
			this.Debe.HeaderText = "Debe Parcial";
			this.Debe.Name = "Debe";
			...
			this.Haber.HeaderText = "Haber Parcial";
			...
			// DebeAcumulado
			// 
			this.DebeAcumulado.DataPropertyName = "DebeAcumulado";
			...
			this.DebeAcumulado.DefaultCellStyle = dataGridViewCellStyle7;
			this.DebeAcumulado.HeaderText = "Debe Acumulado";
			this.DebeAcumulado.Name = "DebeAcumulado";
			this.DebeAcumulado.ReadOnly = true;
			// 
			// HaberAcumulado
			// 
			this.HaberAcumulado.DataPropertyName = "HaberAcumulado";
			...
			this.HaberAcumulado.DefaultCellStyle = dataGridViewCellStyle8;
			this.HaberAcumulado.HeaderText = "Haber Acumulado";
			this.HaberAcumulado.Name = "HaberAcumulado";
			this.HaberAcumulado.ReadOnly = true;
			// 
			// SaldoAcumulado
			// 
			this.SaldoAcumulado.DataPropertyName = "SaldoAcumulado";
			...
			this.SaldoAcumulado.DefaultCellStyle = dataGridViewCellStyle9;
			this.SaldoAcumulado.HeaderText = "Saldo Acumulado";
			this.SaldoAcumulado.Name = "SaldoAcumulado";
			this.SaldoAcumulado.ReadOnly = true;
			// 
			// Usuario
			// 
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn DebeAcumulado;
		private System.Windows.Forms.DataGridViewTextBoxColumn HaberAcumulado;
		private System.Windows.Forms.DataGridViewTextBoxColumn SaldoAcumulado;
